...
const MODAL_CUBROID_GROUP_NUMBER = 'cubroidGroupNumberModal';
...
const initialState = {
    ...
    [MODAL_CUBROID_GROUP_NUMBER]: false
};
...
const openCubroidGroupNumberModal = function () {
    return openModal(MODAL_CUBROID_GROUP_NUMBER);
}
...
const closeCubroidGroupNumberModal = function () {
    return closeModal(MODAL_CUBROID_GROUP_NUMBER);
}
export {
    reducer as default,
